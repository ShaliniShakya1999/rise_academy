<section class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div class="mt-14 grid sm:grid-cols-3 gap-6">
        <div class="rounded-2xl bg-white border border-slate-200 p-6">
            <p class="text-3xl font-display font-extrabold text-brand-700">10K+</p>
            <p class="mt-1 text-sm text-slate-600">resumes created</p>
        </div>
        <div class="rounded-2xl bg-white border border-slate-200 p-6">
            <p class="text-3xl font-display font-extrabold text-brand-700">10+</p>
            <p class="mt-1 text-sm text-slate-600">professional templates</p>
        </div>
        <div class="rounded-2xl bg-white border border-slate-200 p-6">
            <p class="text-3xl font-display font-extrabold text-brand-700">5 min</p>
            <p class="mt-1 text-sm text-slate-600">average build time</p>
        </div>
    </div>
</section>
